...
export const Hero = () => {
  ...
  const { superhero, publisher, alter_ego, first_appearance, characters } = useMemo( () => getHeroeById(id), [ id ] );
  ...
  return (
    <>
      <div className="flex gap-5">
        <div>
          <img src={heroImageURL} className="rounded-lg h-full max-h-[70vh] min-w-72 hover:scale-105" alt={superhero} />
