...
export const HeroCard = ({ id, superhero }) => {
    ...
    return (
        <div className="shadow-md p-6 rounded-md flex flex-col flex-wrap w-64 animate__animated animate__fadeIn">
            ...
            <Link to={`/hero/${id}`} className="mt-3 bg-gradient-to-r from-indigo-500 to-blue-400 hover:from-blue-400 hover:to-indigo-500 w-fit py-2 px-4 text-xs font-normal text-white rounded-md">
                see more...
            </Link>
